                    ...
                    <ul className="nav nav-sidebar-menu sidebar-toggle-view">
                        <li className="nav-item sidebar-nav-item">
                            ...
                            <ul className="nav sub-group-menu">
                                ...
                                <li className="nav-item">
                                    <a href="index5.html" className="nav-link"><i className="fas fa-angle-right"></i>Teachers</a>
                                </li>
                            </ul>
                        </li>
                        <li className="nav-item sidebar-nav-item">
                        ...
                        <li className="nav-item sidebar-nav-item">
                            ...
                            <ul className="nav sub-group-menu">
                                <li className="nav-item">
                                    <a href="all-parents.html" className="nav-link"><i className="fas fa-angle-right"></i>All Parents</a>
                                </li>
                                <li className="nav-item">
                                    <a href="parents-details.html" className="nav-link"><i className="fas fa-angle-right"></i>Parents Details</a>
                                </li>
                                <li className="nav-item">
                                    <a href="add-parents.html" className="nav-link"><i className="fas fa-angle-right"></i>Add Parent</a>
                                </li>
                            </ul>
                        </li>
                        <li className="nav-item sidebar-nav-item">
                            ...
                            <ul className="nav sub-group-menu">
                                <li className="nav-item">
                                    <a href="all-book.html" className="nav-link"><i className="fas fa-angle-right"></i>All Book</a>
                                </li>
                                <li className="nav-item">
                                    <a href="add-book.html" className="nav-link"><i className="fas fa-angle-right"></i>Add New Book</a>
                                </li>
                            </ul>
                        </li>
                        <li className="nav-item sidebar-nav-item">
                        ...
                        <li className="nav-item">
                            <a href="all-subject.html" className="nav-link"><i className="flaticon-open-book"></i><span>Subject</span></a>
                        </li>
                        <li className="nav-item">
                            <a href="class-routine.html" className="nav-link"><i className="flaticon-calendar"></i><span>Class Routine</span></a>
                        </li>
                        <li className="nav-item">
                            <a href="student-attendence.html" className="nav-link"><i className="flaticon-checklist"></i><span>Attendence</span></a>
                        </li>
                        <li className="nav-item sidebar-nav-item">
                            <a href="#" className="nav-link"><i className="flaticon-shopping-list"></i><span>Exam</span></a>
                            <ul className="nav sub-group-menu">
                                <li className="nav-item">
                                    <a href="exam-schedule.html" className="nav-link"><i className="fas fa-angle-right"></i>Exam Schedule</a>
                                </li>
                                <li className="nav-item">
                                    <a href="exam-grade.html" className="nav-link"><i className="fas fa-angle-right"></i>Exam Grades</a>
                                </li>
                            </ul>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <a href="notice-board.html" className="nav-link"><i className="flaticon-script"></i><span>Notice</span></a>
                        </li>
                        <li className="nav-item">
                            <a href="messaging.html" className="nav-link"><i className="flaticon-chat"></i><span>Messeage</span></a>
                        </li>
                         <li className="nav-item sidebar-nav-item">
                        ...
                        <li className="nav-item">
                            <a href="map.html" className="nav-link"><i className="flaticon-planet-earth"></i><span>Map</span></a>
                        </li>
                        <li className="nav-item">
